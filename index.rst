...
-  :doc:`Community-recommended
   hardware </user/hardware/community-recommended-hardware>`
-  :doc:`Hardware compatibility list (HCL) </user/hardware/hcl>`

Downloading, Installing, and Upgrading Qubes
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

-  :doc:`Download Qubes OS </user/downloading-installing-upgrading/downloads>`
...
-  :doc:`How to use block storage
   device </user/how-to-guides/how-to-use-block-storage-devices>`
...
-  :doc:`Suspend/resume
   troubleshooting </user/troubleshooting/resume-suspend-troubleshooting>`
-  :doc:`App menu shortcut
   troubleshooting </user/troubleshooting/app-menu-shortcut-troubleshooting>`
...
-  :doc:`Installing contributed
   packages </user/advanced-topics/installing-contributed-packages>`
...
-  :doc:`How to mount a Qubes partition from another
   OS </user/advanced-topics/mount-from-other-os>`
...
-  :doc:`How to edit the
   documentation </developer/general/how-to-edit-the-documentation>`
...
-  :doc:`Qubes core admin </developer/system/qubes-core-admin>`
-  :doc:`Qubes core admin client </developer/system/qubes-core-admin-client>`
-  :doc:`Qubes core stack </developer/system/qubes-core-stack>`
...
-  :doc:`Qubes template configs </developer/building/qubes-template-configs>`
...
-  :doc:`Windows qubes </external/os-guides/windows/windows>`
-  `Template:
