...
of this site </introduction/faq.html#should-i-trust-this-website>`__), dishonest IT staff
...
website could be compromised </introduction/faq.html#should-i-trust-this-website>`__, so
...
-  If you have access to an existing Qubes installation, the release
   ...
   `copied </user/how-to-guides/how-to-copy-from-dom0.html#copying-from-dom0>`__ into other
...
-  Download it as a file. You can find the RSK for your Qubes release on
   ...
   Signing Key from the `Qubes security pack </project-security/security-pack>` and
...
Please see the `Qubes security pack </project-security/security-pack>` documentation.
...
for every Qubes ISO in the `Qubes security pack </project-security/security-pack>`.
...
2. `Import and authenticate the Qubes Master Signing
   Key. <#how-to-import-and-authenticate-the-qubes-master-signing-key>`__
3. :doc:`Import and authenticate keys from the Qubes security pack
   (qubes-secpack). </project-security/security-pack>` Please see our `PGP key
   policies </project-security/security-pack.html#pgp-key-policies>`__ for important
...
Still have question? Please see :doc:`help, support, mailing lists, and
forum </introduction/support>` for places where you can ask!
