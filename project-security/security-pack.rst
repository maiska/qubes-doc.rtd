...
-  `Qubes ISO cryptographic hash
   values </project-security/verifying-signatures.html#how-to-verify-the-cryptographic-hash-values-of-qubes-isos>`__
-  `Qubes fund
...
`OpenPGP software </project-security/verifying-signatures.html#openpgp-software>`__.
...
3. `Authenticate and set the trust level of the Qubes Master Signing Key
   (QMSK). </project-security/verifying-signatures.html#how-to-import-and-authenticate-the-qubes-master-signing-key>`__
...
-  **Inclusion criteria.** The qubes-secpack generally includes only
   ...
   team </project-security/security.html#qubes-security-team>`__ email address, which is used
