...
*within* Qubes OS, see `security in Qubes </#security-in-qubes>`__.
...
-  `Qubes security bulletins (QSBs) </project-security/qsb>`
-  `Qubes canaries </project-security/canary>`
-  `Xen security advisory (XSA) tracker </project-security/xsa>`
-  `Verifying signatures </project-security/verifying-signatures>`
-  `PGP keys <https://keys.qubes-os.org/keys/>`__
-  `Security FAQ </introduction/faq.html#general--security>`__
...
(QSB) </project-security/qsb>` that describes the issue, discusses the
...
Qubes security updates are obtained by :doc:`updating Qubes
OS </user/how-to-guides/how-to-update>`.

Qubes security team
-------------------

The **Qubes security team (QST)** is the subset of the `core
team <https://www.qubes-os.org/team/#core-team>`__ that is responsible for ensuring the security
...
-  Writing, signing, and publishing :doc:`Qubes security bulletins
   (QSBs) </project-security/qsb>`
-  Writing, signing, and publishing :doc:`Qubes
   canaries </project-security/canary>`
...
-  `Joanna Rutkowska <https://www.qubes-os.org/team/#joanna-rutkowska>`__ (`emeritus, canaries
   only <https://www.qubes-os.org/news/2018/11/05/qubes-security-team-update/>`__)
