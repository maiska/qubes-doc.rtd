...
OS </user/downloading-installing-upgrading/installation-guide>`, we offer to set up
...
Policy <https://www.qubes-os.org/website-privacy-policy/>`__.
...
the `documentation </>`__ in Markdown so that the plain text can be
...
website? </introduction/faq.html#should-i-trust-this-website>`__
...
include IP addresses. We use this data for generating :doc:`Qubes userbase
statistics </introduction/statistics>` and for incident response.
...
route all of your updates over Tor when :doc:`installing Qubes
OS </user/downloading-installing-upgrading/installation-guide>`.
...
used both for `ISO downloads </user/downloading-installing-upgrading/downloads.html#mirrors>`__ and
...
privacy? </introduction/faq.html#how-does-qubes-os-provide-privacy>`__
