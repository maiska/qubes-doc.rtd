...
please see `Help, Support, Mailing Lists, and Forum </introduction/support>`.

I see something that should be changed in the documentation.
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

We encourage you to submit the change yourself! Please see the :doc:`how to
edit the documentation </developer/general/how-to-edit-the-documentation>` for
...
2.  `Search through the existing issues <#search-tips>`__, both open and
    ...
    `Do not open a
    duplicate. </introduction/issue-tracking.html#new-issues-should-not-be-duplicates-of-existing-issues>`__
...
closed </introduction/issue-tracking.html#how-issues-get-closed>`__ for details about
...
`here </developer/releases/version-scheme.html#bug-priorities>`__ for details about how the
...
Forum </introduction/support>`). You can simply link to the relevant issue in your
discussion post.
...
Forum </introduction/support>` for appropriate place to ask questions. By
contrast,
...
If your issue is not actionable, please see :doc:`Help, Support, Mailing
Lists, and Forum </introduction/support>` for the appropriate place to post it. If
