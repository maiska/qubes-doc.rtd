...
issues </user/troubleshooting/pci-troubleshooting.html#pci-passthrough-issues>`__.
...
see the `USB
documentation </user/how-to-guides/how-to-use-usb-devices.html#creating-and-using-a-usb-qube>`__.
...
Devices
documentation </user/how-to-guides/how-to-use-block-storage-devices.html#what-if-i-removed-the-device-before-detaching-it-from-the-vm>`__
...
dom0 </user/advanced-topics/usb-qubes.html#how-to-hide-usb-controllers-from-dom0>`__ (i.e.,
...
qube </user/how-to-guides/how-to-use-usb-devices.html#creating-and-using-a-usb-qube>`__
