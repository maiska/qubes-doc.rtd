...
-  **Verify your Qubes ISO:** Errors will occur if the Qubes installer
   ...
   before writing it to a flash drive by :doc:`verifying the
   ISO </project-security/verifying-signatures>`.
-  **Change the method you used to**\ `write your ISO to a USB
   key </user/downloading-installing-upgrading/installation-guide.html#copying-the-iso-onto-the-installation-medium>`__\ **:**
...
then disable one and try the other. Visit the :doc:`UEFI Troubleshooting
guide </user/troubleshooting/uefi-troubleshooting>` if other errors arise during UEFI
booting.
...
setup </user/downloading-installing-upgrading/installation-guide.html#initial-setup>`__, which is generally
...
requirements </user/downloading-installing-upgrading/installation-guide.html#hardware-requirements>`__ section
...
here </introduction/faq.html#why-is-vt-damd-viamd-iommu-important>`__:
