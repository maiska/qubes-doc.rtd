...
1. Follow the `steps
   here </user/troubleshooting/uefi-troubleshooting.html#successfully-installed-in-legacy-mode-but-had-to-change-some-kernel-parameters>`__
...
follow `these
steps </user/troubleshooting/uefi-troubleshooting.html#boot-device-not-recognized-after-installing>`__
...
1. Boot into `rescue
   mode </user/troubleshooting/uefi-troubleshooting.html#accessing-installer-rescue-mode-on-uefi>`__.
