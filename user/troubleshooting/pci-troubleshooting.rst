...
`PCI Devices
documentation </user/how-to-guides/how-to-use-pci-devices.html#additional-attach-options>`__.
...
issue </user/troubleshooting/pci-troubleshooting.html#pci-passthrough-issues>`__, which
...
`Suspend/Resume
Troubleshooting </user/troubleshooting/resume-suspend-troubleshooting.html#attached-devices-in-windows-hvm-stop-working-on-suspendresume>`__
for a solution.
...
`FAQs </introduction/faq.html#i-assigned-a-pci-device-to-a-qube-then-unassigned-itshut-down-the-qube-why-isnt-the-device-available-in-dom0>`__
