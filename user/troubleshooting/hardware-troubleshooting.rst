...
`here </user/advanced-topics/how-to-install-software-in-dom0.html#kernel-upgrade>`__ for more
...
See `Installation
Troubleshooting </user/troubleshooting/installation-troubleshooting.html#unsupported-hardware-detected-error>`__.
