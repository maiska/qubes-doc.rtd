...
-  **Graphics:** Intel integrated graphics processor (IGP) strongly
   ...
   -  Nvidia GPUs may require significant
      :doc:`troubleshooting </external/configuration-guides/install-nvidia-driver>`
...
-  **Other:** Satisfaction of all `hardware certification requirements
   for Qubes 4.x <https://www.qubes-os.org/news/2016/07/21/new-hw-certification-for-q4/>`__
...
-  Qubes **can** be installed on a USB flash drive or external disk, and
   ...
   reports </user/hardware/how-to-use-the-hcl.html#generating-and-submitting-new-reports>`__
