...
clipboard. See*\ :doc:`copying and pasting text between
qubes </user/how-to-guides/how-to-copy-and-paste-text>`\ *. For dom0, see*\ :doc:`copying
from (and to) dom0 </user/how-to-guides/how-to-copy-from-dom0>`\ *.*
