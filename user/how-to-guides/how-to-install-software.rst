...
install it in a `template </user/reference/glossary.html#template>`__. For installing
templates themselves, see `how to install a
template </user/templates/templates.html#installing>`__. Advanced users may also be
interested in learning how to install software in
`standalones </user/advanced-topics/standalones-and-hvms>` and
...
when you `update Qubes normally </user/how-to-guides/how-to-update>`, which means
...
-  If your software requires special files or directories to be
   persistent, and you’re an advanced user, see :doc:`standalones and
   HVMs </user/advanced-topics/standalones-and-hvms>` and :doc:`how to make any file
   persistent (bind-dirs) </user/advanced-topics/bind-dirs>`.
-  :doc:`Ask for help. </introduction/support>`

How to update software
----------------------

Please see `How to Update </user/how-to-guides/how-to-update>`.
...
testing repos, see
:doc:`here </user/advanced-topics/how-to-install-software-in-dom0.html#testing-repositories>`__.
For testing new templates, please see
:doc:`here </user/downloading-installing-upgrading/testing.html#templates>`__.
...
`standalones </user/reference/glossary.html#standalone>`__ is the same as described
...
There are two services (``qvm-service``, :doc:`service
framework </user/advanced-topics/qubes-service>`):
