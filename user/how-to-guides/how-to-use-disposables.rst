A `disposable </user/reference/glossary.html#disposable>`__ is a lightweight
`qube </user/reference/glossary.html#qube>`__ that can be created quickly and will
...
If a `disposable template </user/reference/glossary.html#disposable-template>`__
...
`template </user/reference/glossary.html#template>`__, disposables are based on their
underlying `disposable template </user/reference/glossary.html#disposable-template>`__.
...
:doc:`here </developer/services/qrexec.html#qubes-rpc-administration>`__.
