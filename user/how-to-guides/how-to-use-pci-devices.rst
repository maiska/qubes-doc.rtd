...
`security
considerations </user/security-in-qubes/device-handling-security.html#pci-security>`__ before
...
considerations </user/security-in-qubes/device-handling-security.html#pci-security>`__. In the
...
implications </user/security-in-qubes/device-handling-security.html#pci-security>`__! **Make
