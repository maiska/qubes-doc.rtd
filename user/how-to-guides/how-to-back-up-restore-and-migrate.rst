...
3. Select the destination for the backup:
   ...
   to send your backup to a `USB mass storage device </user/how-to-guides/how-to-use-usb-devices>`, you
...
2. Select the source location of the backup to be restored:
   ...
   -  If your backup is located on a :doc:`USB mass storage
      device </user/how-to-guides/how-to-use-usb-devices>`, attach it first to another VM or select
...
another, simply follow the backup procedure on the old machine, :doc:`install
Qubes </user/downloading-installing-upgrading/downloads>` on the new machine, and follow the restoration
