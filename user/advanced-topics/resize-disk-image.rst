...
settings, but the system root image is :doc:`inherited from the
template </introduction/getting-started>`, and so it must be changed in the
...
If you have a SSD see :doc:`here </external/configuration-guides/disk-trim>` for information on using
fstrim.
