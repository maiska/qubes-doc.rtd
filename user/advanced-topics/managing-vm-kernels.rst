...
`here </user/advanced-topics/how-to-install-software-in-dom0.html#kernel-upgrade>`__ for
...
guide </user/troubleshooting/vm-troubleshooting.html#vm-kernel-troubleshooting>`__ to learn
