...
devices </user/security-in-qubes/device-handling-security.html#usb-security>`__. Nonetheless,
we strongly recommend carefully reading the `security warning on USB
input
devices </user/security-in-qubes/device-handling-security.html#security-warning-on-usb-input-devices>`__
before proceeding.
...
dom0 </user/advanced-topics/how-to-install-software-in-dom0.html#how-to-update-dom0>`__.
...
1. `Find the controller used for input
   devices </user/how-to-guides/how-to-use-usb-devices.html#finding-the-right-usb-controller>`__.
...
entry </introduction/faq.html#i-created-a-usb-vm-and-assigned-usb-controllers-to-it-now-the-usb-vm-wont-boot>`__.
