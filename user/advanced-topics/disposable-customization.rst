...
A :doc:`disposable </user/how-to-guides/how-to-use-disposables>` can be based on any `app
qube </user/reference/glossary.html#app-qube>`__. You can also choose to use different
`disposable templates </user/reference/glossary.html#disposable-template>`__ for
...
documentation </developer/services/qrexec.html#specifying-vms-tags-types-targets-etc>`__
for details.

If you wish to use a `Minimal Template </user/templates/minimal-templates>` as a
disposable template, please see the :doc:`Minimal
Template </user/templates/minimal-templates>` page.
...
You can use a `named disposable </user/reference/glossary.html#named-disposable>`__ for
...
`determine </user/how-to-guides/how-to-use-pci-devices.html#qvm-pci-usage>`__ the
``<BDF>``. Also, you will often need to include the
``-o no-strict-reset=True``
`option </user/how-to-guides/how-to-use-pci-devices.html#no-strict-reset>`__ with USB
controllers.
...
5. Attach the USB controller to the ``disp-sys-usb``: >\ **Note:** Most
   ...
   :doc:`here </user/how-to-guides/how-to-use-pci-devices.html#no-strict-reset>`__.
...
8. Users should now follow instructions on `How to hide USB controllers
   from dom0 </user/advanced-topics/usb-qubes.html#how-to-hide-usb-controllers-from-dom0>`__.
...
:doc:`here </user/troubleshooting/pci-troubleshooting.html#pci-passthrough-issues>`__.
