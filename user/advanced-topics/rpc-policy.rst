...
Please see*\ `this
article <https://www.qubes-os.org/news/2020/06/22/new-qrexec-policy-system/>`__\ *for details.*

This document explains the basics of RPC policies in Qubes. For more
information, see `Qrexec: command execution in VMs </developer/services/qrexec>`.
