...
API <https://www.qubes-os.org/news/2017/06/27/qubes-admin-api/>`__) in pillar data of the
...
Domain <https://www.qubes-os.org/news/2020/03/18/gui-domain/#the-compromise-solution>`__.
...
Domain <https://www.qubes-os.org/news/2020/03/18/gui-domain/#gpu-passthrough-the-perfect-world-desktop-solution>`__.
...
method with ``qvm-pci`` (see :doc:`How to use PCI
devices </user/how-to-guides/how-to-use-pci-devices>`).
...
Domain <https://www.qubes-os.org/news/2020/03/18/gui-domain/#virtual-server-the-perfect-remote-solution>`__.
