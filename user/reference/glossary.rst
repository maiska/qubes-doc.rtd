...
See `Standalones and HVM </user/advanced-topics/standalones-and-hvms>`.
...
See :doc:`Qubes Windows Tools </external/os-guides/windows/windows-tools>` and
:doc:`Windows </external/os-guides/windows/windows>`.
