...
Qubes OS has very specific :doc:`system
requirements </user/hardware/system-requirements>`. To ensure compatibility, we
strongly recommend using :doc:`Qubes-certified
hardware </user/hardware/certified-hardware>`. Other hardware may require you
...
`Download </user/downloading-installing-upgrading/downloads>` a Qubes ISO.
...
.. container:: alert alert-warning
   ...
   when choosing an installation medium.
...
supported (see `Advanced Topics </#advanced-topics>`__).
...
The Qubes OS Project occasionally issues :doc:`Qubes Security Bulletins
(QSBs) </project-security/qsb>` as part of the :doc:`Qubes Security Pack
(qubes-secpack) </project-security/security-pack>`. It is important to make sure that
...
`qubes-announce </introduction/support.html#qubes-announce>`__ mailing list.

In addition to QSBs, the Qubes OS Project also publishes
:doc:`Canaries </project-security/canary>`, XSA summaries, template releases and
...
to `qubes-announce </introduction/support.html#qubes-announce>`__ in order to keep the
...
feed <https://www.qubes-os.org/feed.xml>`__ or join one of our other `venues </introduction/support>`,
...
your data unexpectedly. The :doc:`Qubes backup
...
out the other `How-To Guides </#how-to-guides>`__, and learn about
...
-  If issues arise during installation, see the :doc:`Installation
   Troubleshooting </user/troubleshooting/installation-troubleshooting>` guide.

-  If you don’t find your answer in the documentation, please see `Help,
   Support, Mailing Lists, and Forum </introduction/support>` for places to ask.
