...
there are no easy solutions. (Tools like :doc:`Anti Evil Maid
(AEM) </user/security-in-qubes/anti-evil-maid>` can help with *maintaining* the
...
-  Untrustworthy firmware. (Firmware can be malicious even if the drive
   ...
   drive <https://srlabs.de/badusb/>`__. Installing from a compromised
