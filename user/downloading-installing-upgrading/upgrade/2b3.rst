...
reason, **we strongly recommended that users perform a**\ :doc:`clean
installation </user/downloading-installing-upgrading/installation-guide>`\ **of Qubes R2 Beta 3**.
...
built-in**\ `backup tool </user/how-to-guides/how-to-back-up-restore-and-migrate>`\ **.**
