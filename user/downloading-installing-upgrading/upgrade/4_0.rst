...
systems </user/how-to-guides/how-to-back-up-restore-and-migrate>`\ **.**
...
3. Follow the **Creating a Backup** section in the `Backup, Restoration,
   and Migration </user/how-to-guides/how-to-back-up-restore-and-migrate>` guide to back up **all VMs**
   except sys-usb.

4. Verify the integrity of your backup by following the **Restoring from
   a Backup** section in the `Backup, Restoration, and
   Migration </user/how-to-guides/how-to-back-up-restore-and-migrate>` guide and:
...
5. Follow the **Restoring from a Backup** section in the :doc:`Backup,
   Restoration, and Migration </user/how-to-guides/how-to-back-up-restore-and-migrate>` guide. We
   recommend that you restore only your `app
   qubes </user/reference/glossary.html#app-qube>`__ and
   `standalones </user/reference/glossary.html#standalone>`__ from R3.2. Using
   :doc:`templates </user/templates/templates>` and `service
   qubes </user/reference/glossary.html#service-qube>`__ from R3.2 is not fully
   supported (see
   ...
   releases </user/downloading-installing-upgrading/supported-releases.html#templates>`__. If the restore tool
...
you upgrade them before use. Please see :doc:`supported
releases </user/downloading-installing-upgrading/supported-releases>` for information on supported OS
versions and consult the guides below for specific upgrade instructions:

-  `Upgrading Fedora templates </user/templates/fedora/fedora.html#upgrading>`__
-  `Upgrading Debian templates </user/templates/debian/debian.html#upgrading>`__
-  `Updating Whonix
