...
we strongly recommend that users**\ :doc:`back up their
...
Please note that if you use `Anti Evil Maid </user/security-in-qubes/anti-evil-maid>`, it
...
FAQ </introduction/faq.html#i-created-a-usb-vm-and-assigned-usb-controllers-to-it-now-the-usb-vm-wont-boot>`__
for details.
