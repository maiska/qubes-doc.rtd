...
encounter </introduction/issue-tracking>`.
...
-  Enable `dom0 testing
   repositories </user/advanced-topics/how-to-install-software-in-dom0.html#testing-repositories>`__.
-  Enable `template testing
   repositories </user/how-to-guides/how-to-install-software.html#testing-repositories>`__.
...
-  For official templates, enable the ``qubes-templates-itl-testing``
   repository, then `install </user/templates/templates.html#installing>`__ the desired
   template.
-  For community templates, enable the
   ``qubes-templates-community-testing`` repository, then
   `install </user/templates/templates.html#installing>`__ the desired template.
...
be migrated to a stable repository. If you :doc:`report a
bug </introduction/issue-tracking>` in a package that is in a testing
