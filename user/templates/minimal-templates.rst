...
2. If something works with a standard template but not the minimal
   ...
   do *not* file a bug report. Instead, please see :doc:`Help, Support,
   Mailing Lists, and Forum </introduction/support>` for the appropriate place to
   ask for help. Once you have learned how to solve your problem, please
   :doc:`contribute what you learned to the
...
3. The minimal templates are intentionally *minimal*. `Do not ask for
   ...
   default. </introduction/faq.html#could-you-please-make-my-preference-the-default>`__
...
It is an intentional design choice for :doc:`Passwordless Root Access in
VMs </user/security-in-qubes/vm-sudo>` to be optional in minimal templates. Since the
