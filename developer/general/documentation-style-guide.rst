...
be fixed or improved, please :doc:`edit the
documentation </developer/general/how-to-edit-the-documentation>`!
...
the website as a whole, please see the :doc:`website style
guide </developer/general/website-style-guide>`.
...
See `how to add
images </developer/general/how-to-edit-the-documentation.html#how-to-add-images>`__ for
...
the documentation
index </developer/general/how-to-edit-the-documentation.html#how-to-edit-the-documentation-index>`__)
to add and update Qubes Community links in the `“External
documentation” </#external-documentation>`__ section of the
...
guidelines </developer/code/coding-style.html#commit-message-guidelines>`__.
