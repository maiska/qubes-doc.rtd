...
guide </developer/general/documentation-style-guide>`\ *.*
...
-  To give your contribution a better chance of being accepted, please
   follow our :doc:`documentation style
   guide </developer/general/documentation-style-guide>`.
...
-  We don’t want you to spend time and effort on a contribution that we
   ...
   `file an issue </introduction/issue-tracking>` for it first so that we can
...
-  Finally, if you’ve written something that doesn’t belong in qubes-doc
   ...
   documentation </developer/general/documentation-style-guide.html#core-vs-external-documentation>`__.
...
(a.k.a. table of contents) </>`__ — for example, if you’re adding a
...
(see `here </developer/general/documentation-style-guide.html#image-linking>`__ for why
...
documentation </#external-documentation>`__ (see
