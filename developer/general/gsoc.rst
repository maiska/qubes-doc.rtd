...
OS team <https://www.qubes-os.org/team/>`__. You can read more about the Google Summer of Code
...
development </introduction/contributing.html#contributing-code>`__ and `how to send
patches </developer/code/source-code.html#how-to-send-patches>`__. In order to
contribute code to the Qubes project, you must be able to :doc:`sign your
code </developer/code/code-signing>`.
...
lists </introduction/support.html#qubes-devel>`__ for help. The GSoC timeline reserves a
...
-  Join the `qubes-devel list </introduction/support.html#qubes-devel>`__ and introduce
...
`qubes-builder </developer/building/qubes-builder>`, our code-signing policies, and
...
list </introduction/support.html#qubes-devel>`__ and associated GitHub issue to learn
more about the idea.
...
**Mentor**: `Wojtek Porczyk <https://www.qubes-os.org/team/>`__, `Marek
Marczykowski-Górecki <https://www.qubes-os.org/team/>`__
...
**Mentor**: `Frédéric Pierret <https://www.qubes-os.org/team/>`__, `Marek
Marczykowski-Górecki <https://www.qubes-os.org/team/>`__
...
-  “`Security challenges for the Qubes build
   process <https://www.qubes-os.org/news/2016/05/30/build-security/>`__”
-  `This mailing list
...
**Mentor**: Inquire on `qubes-devel </introduction/support.html#qubes-devel>`__.
