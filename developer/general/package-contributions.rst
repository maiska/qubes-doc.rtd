...
want to install contributed packages, please see*\ :doc:`installing
contributed packages </user/advanced-topics/installing-contributed-packages>`\ *.*
...
-  Be published under an open-source license (read about the :doc:`Qubes OS
   License </developer/code/license>`).
...
community on the `qubes-devel mailing list </introduction/support.html#qubes-devel>`__.
...
3. If you haven’t already, `sign your code </developer/code/code-signing>`.
