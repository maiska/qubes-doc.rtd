...
`qubes </user/reference/glossary.html#qube>`__, which are implemented as lightweight
`virtual machines (VMs) </user/reference/glossary.html#vm>`__. For example, the user
...
rest of the `System Documentation </#system>`__.)
