...
signatures </project-security/verifying-signatures.html#how-to-import-and-authenticate-the-qubes-master-signing-key>`__
...
`procedure </developer/building/qubes-iso-building.html#build-using-manual-steps>`__ at
...
under :doc:`Extra Whonix Build Options </external/building-guides/building-whonix-template>`.

You may also want to add
``COMPONENTS := $(filter-out gcc,$(COMPONENTS))`` to bypass a multiple
hour compile step. See
:doc:`QubesBuilder </developer/building/qubes-builder.html#use-pre-built-qubes-packages>`__ for
more detail.
...
:doc:`Extra Whonix Build Options </external/building-guides/building-whonix-template>`.
