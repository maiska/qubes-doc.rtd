...
You may also like to run your :doc:`test environment on separate
machine </developer/debugging/test-bench>`.
...
forwarding </user/security-in-qubes/firewall.html#port-forwarding-to-a-qube-from-the-outside-world>`__
