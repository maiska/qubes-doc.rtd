...
see*\ :doc::doc:`here </developer/services/qrexec>`\ *.*)
...
of qrexec v3, see*\ :doc::doc:`here </developer/services/qrexec-internals>`\ *. Note that the
...
apps. Also note the :doc:`qrexec framework implemention in Qubes
R3 </developer/services/qrexec>` significantly differs from what is described in
this section.
