...
see*\ `here </developer/services/qrexec2.html#qubes-rpc-internals>`__\ *.*)
...
administration </developer/services/qrexec.html#qubes-rpc-administration>`__.
...
It is a :doc:`socket-based Qubes RPC
service </developer/services/qrexec-socket-services>`. Requests are in JSON format,
