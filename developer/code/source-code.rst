...
code </introduction/contributing.html#contributing-code>`__ to the project, there are
two ways. Whichever method you choose, you must :doc:`sign your
code </developer/code/code-signing>` before it can be accepted.
...
-  **Preferred**: Use GitHub’s `fork & pull
   ...
   list </introduction/support.html#qubes-devel>`__ in order to notify people who do not
   receive GitHub notifications.

-  Send a patch to the `qubes-devel mailing
   list </introduction/support.html#qubes-devel>`__ (``git format-patch``).
