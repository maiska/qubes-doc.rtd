...
-  Management Stack extended to support in-VM configuration -
   :doc::doc:`documentation </user/advanced-topics/salt>`
-  PV USB - :doc::doc:`documentation </user/how-to-guides/how-to-use-usb-devices>`
...
-  More flexible Qubes RPC services - `related
   ...
   :doc::doc:`documentation </developer/services/qrexec.html#service-policies-with-arguments>`__
...
-  `Fedora 23 reached EOL in December
   ...
   VMs <https://www.qubes-os.org/news/2018/01/06/fedora-26-upgrade/>`__.
...
26 <https://www.qubes-os.org/news/2018/01/06/fedora-26-upgrade/>`__.
...
from scratch and use :doc:`qubes backup and restore
tools </user/how-to-guides/how-to-back-up-restore-and-migrate>` for migrating of all of the user VMs.

Users of Qubes R3.1 can also upgrade using :doc:`this
procedure </user/downloading-installing-upgrading/upgrade/3_2>`.

From R3.0 or earlier
~~~~~~~~~~~~~~~~~~~~

When upgrading from earlier versions the easiest and safest way is to
install it from scratch and use :doc:`qubes backup and restore
tools </user/how-to-guides/how-to-back-up-restore-and-migrate>` for migrating of all of the user VMs.

Alternatively you can `upgrade to R3.1
using </developer/releases/3_1/release-notes.html#upgrading>`__ first, then follow
