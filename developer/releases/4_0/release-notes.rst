...
-  With R4.0.1, which ships kernel-4.19, you may never reach the
   ...
   `disabling </user/troubleshooting/uefi-troubleshooting.html#installation-freezes-before-displaying-installer>`__
...
migrating of all of the user VMs. We also provide :doc:`detailed
instruction </user/downloading-installing-upgrading/upgrade/4_0>` for this procedure.
