...
-  Colorful window application icons (instead of just colorful lock
   icon)
-  PV Grub support (:doc::doc:`documentation </user/advanced-topics/managing-vm-kernels>`)
...
Users of Qubes R3.0 can upgrade using :doc:`experimental
procedure </user/downloading-installing-upgrading/upgrade/3_1>`.
...
using </developer/releases/3_0/release-notes.html#upgrading>`__ first, then follow
